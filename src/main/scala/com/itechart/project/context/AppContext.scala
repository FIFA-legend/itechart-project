...
import com.itechart.project.routes.{CategoryRoutes, ItemRoutes, SupplierRoutes}
import com.itechart.project.services.{CategoryService, ItemService, SupplierService}
...
object AppContext {
  ...
  def setUp[F[_]: ContextShift: Async: Logger](configuration: AppConfiguration): Resource[F, HttpApp[F]] = {
    ...
    } yield (categoryRoutes <+> supplierRoutes <+> itemRoutes).orNotFound
  }
